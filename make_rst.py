...
class State:
    ...
    def parse_class(self, class_root: ET.Element, filepath: str) -> None:
        ...
        # Sanitize the class name here by removing unwanted characters
        class_name = class_name.replace('&quot;', '').replace('./', '').replace('/', '_').replace('"', '')
        #print(f"Sanitized class name: {class_name}")  # Add this line for debugging
        ...
        if inherits is not None:
            ...
            #print(f"Sanitized inherit name: {inherits}")
...
def make_rst_class(class_def: ClassDef, state: State, dry_run: bool, output_dir: str) -> None:
    ...
    f.write(".. DO NOT EDIT THIS FILE!!! (unless you want to)\n")
    f.write(".. Generated automatically from gdscript XML class references\n")
